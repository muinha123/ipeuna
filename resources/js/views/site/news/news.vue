            ...
            <div class="container">
                    ...
                    <div class="col-md-12 col-lg-12">
                        <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <router-link :to="{name: 'site.news'}">Notícias</router-link>
                                </li>
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="title-single-box">
                        <h3 class="post-intro text-center">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="news-img-box text-center">
                            <img src="/site/assets//img/slide-3.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
                        ...
                        <div class="post-information">
                            <ul class="list-inline text-center color-a">
                                ...
                                <li class="list-inline-item mr-2">
                                    ...
                                    <span class="color-text-a">Policial</span>
                                </li>
                            ...
                            <ul class="list-comments">
                                <li>
                                    <div class="comment-avatar">
                                        <img src="/site/assets//img/author-2.jpg" alt="">
                                    </div>
                                ...
                                <li class="comment-children">
                                    <div class="comment-avatar">
                                        <img src="/site/assets//img/author-1.jpg" alt="">
                                    </div>
                                    <div class="comment-details">
